...
**Read First**: [`MVP_REQUIREMENTS.md`](MVP_REQUIREMENTS.md) - Complete MVP scope and boundaries
...
**Key Documents**: [`ARCHITECTURE.md`](ARCHITECTURE.md), [`specs/DATABASE_SCHEMA.md`](specs/DATABASE_SCHEMA.md)

### Frontend Team (Flutter)
**Primary Files**: `mobile/lib/`, `mobile/test/`
**Key Documents**: [`specs/FRONTEND_ARCHITECTURE.md`](specs/FRONTEND_ARCHITECTURE.md), [`design/UI_COMPONENTS.md`](design/UI_COMPONENTS.md)

### DevOps Team (Part-time)
**Primary Files**: `docker/`, `.github/workflows/`, `scripts/`
**Key Documents**: [`DEPLOYMENT.md`](DEPLOYMENT.md), [`SETUP.md`](SETUP.md)
...
1. **Initialize Rust Project**
   ...
   - **Reference docs**: [`SETUP.md`](SETUP.md), [`ARCHITECTURE.md`](ARCHITECTURE.md)
...
2. **Database Setup**
   ...
   - **Reference docs**: [`specs/DATABASE_SCHEMA.md`](specs/DATABASE_SCHEMA.md)
...
3. **Clerk Authentication**
   ...
   - **Reference docs**: [`specs/AUTHENTICATION.md`](specs/AUTHENTICATION.md)
...
1. **Flutter Project Setup**
   ...
   - **Reference docs**: [`specs/FRONTEND_ARCHITECTURE.md`](specs/FRONTEND_ARCHITECTURE.md)
...
2. **Authentication Screens**
   ...
   - **Reference docs**: [`specs/AUTHENTICATION.md`](specs/AUTHENTICATION.md), [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md)
...
- **Reference docs**: [`specs/API.md`](specs/API.md) (User endpoints section)
...
- **Reference docs**: [`specs/API.md`](specs/API.md) (Family endpoints section)
...
- **Reference docs**: [`specs/AUTHENTICATION.md`](specs/AUTHENTICATION.md) (Webhooks section)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (New User Onboarding section)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Family Invitation Flow section)
...
- **Reference docs**: [`design/UI_COMPONENTS.md`](design/UI_COMPONENTS.md) (Profile components)
...
- **Reference docs**: [`specs/API.md`](specs/API.md) (Upload endpoints)
...
- **Reference docs**: [`specs/AUDIO_PROCESSING.md`](specs/AUDIO_PROCESSING.md) (OCR section)
...
- **Reference docs**: [`specs/DATABASE_SCHEMA.md`](specs/DATABASE_SCHEMA.md) (Stories table)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Story Creation Flow section)
...
- **Reference docs**: [`design/UI_COMPONENTS.md`](design/UI_COMPONENTS.md) (Text editor)
...
- **Reference docs**: [`specs/AUDIO_PROCESSING.md`](specs/AUDIO_PROCESSING.md) (TTS section)
...
- **Reference docs**: [`specs/API.md`](specs/API.md) (Audio endpoints)
...
- **Reference docs**: [`ARCHITECTURE.md`](ARCHITECTURE.md) (Job processing section)
...
- **Reference docs**: [`design/AUDIO_UX.md`](design/AUDIO_UX.md)
...
- **Reference docs**: [`specs/API.md`](specs/API.md) (Dashboard endpoints)
...
- **Reference docs**: [`specs/DATABASE_SCHEMA.md`](specs/DATABASE_SCHEMA.md) (Sharing permissions)
...
- **Reference docs**: [`specs/EMAIL_INTEGRATION.md`](specs/EMAIL_INTEGRATION.md)
...
- **Reference docs**: [`design/UI_COMPONENTS.md`](design/UI_COMPONENTS.md) (Dashboard components)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Story Consumption Flow section)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Family Management Flow section)
...
- **Reference docs**: [`MVP_REQUIREMENTS.md`](MVP_REQUIREMENTS.md) (Payment System section)
...
- **Reference docs**: [`MVP_REQUIREMENTS.md`](MVP_REQUIREMENTS.md) (Free vs Paid tiers)
...
- **Reference docs**: [`specs/PAYMENT_SYSTEM.md`](specs/PAYMENT_SYSTEM.md)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Subscription Management Flow)
...
- **Reference docs**: [`design/UI_COMPONENTS.md`](design/UI_COMPONENTS.md), [`MVP_REQUIREMENTS.md`](MVP_REQUIREMENTS.md)
...
- **Reference docs**: [`TESTING.md`](TESTING.md) (Accessibility Testing section)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Error Recovery Flows section)
...
- **Reference docs**: [`MVP_USER_FLOWS.md`](MVP_USER_FLOWS.md) (Cross-Platform Considerations)
...
- **Reference docs**: [`TESTING.md`](TESTING.md) (Performance Testing section)
...
- **Reference docs**: [`TESTING.md`](TESTING.md) (End-to-End Tests section)
...
- **Reference docs**: [`DEPLOYMENT.md`](DEPLOYMENT.md) (Simple Deployment section)
...
- **Reference docs**: [`ops/MONITORING.md`](ops/MONITORING.md)
